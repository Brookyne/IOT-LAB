       ...
       * reads DHT20 sensor data (humidity only), 
      ...
      bool initThingsBoard() {
        ...
        tb.sendAttributeData("deviceType", "Humidity Monitor");
      ...
      // Sensor data collection and transmission task - HUMIDITY ONLY
      void sensor_task(void *pvParameters) {
        while(1) {
          ...
          if (isnan(humidity)) {
            Serial.println("Failed to read humidity from DHT20 sensor!");
          } else {
            Serial.print("Humidity: ");
            Serial.print(humidity);
            Serial.println(" %");
      
            // Send telemetry data - HUMIDITY ONLY
      ...
      void setup() {
        ...
        Serial.println("\n===========================");
        Serial.println("ESP32 Humidity Monitor with OTA");
